  ...
  <v-card>
    ...
    <v-stepper class="rounded-0" v-model="step">
      <v-stepper-header class="elevation-0">
        ...
        <v-stepper-step :complete="step > 2" step="2">Select Book</v-stepper-step>
      ...
      <v-stepper-items class="fpt-0">
        ...
        <v-stepper-content step="2">
          <div>
            <v-select :items="bookItems" v-model="form.bookId"
                      label="Select Book"></v-select>
...
<script>
  ...
  export default {
    ...
    computed: mapGetters('books', ['bookItems']),
    methods: {
